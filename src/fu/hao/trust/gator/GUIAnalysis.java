...
public class GUIAnalysis {
	...
	public static Set<Integer> allLayoutIds = Sets.newHashSet();
	public static Set<Integer> allMenuIds = Sets.newHashSet();
	public static Set<Integer> allWidgetIds = Sets.newHashSet();
	public static Set<Integer> allStringIds = Sets.newHashSet();
